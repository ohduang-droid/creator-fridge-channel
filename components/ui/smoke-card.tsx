...
const SmokeCard: React.FC<SmokeCardProps> = ({ className = "", onMouseMove: externalOnMouseMove, onMouseLeave: externalOnMouseLeave }) => {
  ...
  return (
    ...
    >
      <canvas
        ref={canvasRef}
        className="absolute top-0 left-0 w-full h-full cursor-none pointer-events-none"
      />
    </div>
  );
};
