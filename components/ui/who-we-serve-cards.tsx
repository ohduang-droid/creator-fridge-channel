        ...
        {duplicatedCards.map((card, index) => {
          ...
          return (
            <div
              ...
              className="flex h-full w-[400px] min-w-[450px] flex-shrink-0 2xl:w-[450px] mx-6"
            >
              <Link href={card.link} className="block h-full w-full">
                <article className="aspect-[430/256] h-full min-h-[290px] w-full overflow-hidden bg-[#F7F3ED] text-black rounded-[2rem] duration-300 ease-in-out shadow-sm transition-all hover:bg-white group">
                  <div className="h-full p-2">
                    <div className="relative flex h-full w-full overflow-hidden rounded-3xl">
                      {/* Text content - left 2/3 */}
                      <div className="relative z-10 flex h-full w-2/3 flex-col items-start justify-between rounded-3xl p-4 after:absolute after:inset-0 after:z-5 after:translate-x-[10px] after:rounded-2xl after:content-[''] after:bg-[#F7F3ED] after:pointer-events-none after:duration-300 after:ease-in-out after:transition-all group-hover:after:bg-white">
