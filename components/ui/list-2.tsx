...
export const List2: React.FC<List2Props> = ({
              ...
              <div className="grid items-center gap-4 px-4 py-5 md:grid-cols-4">
                <div className="order-2 flex items-center gap-2 md:order-none">
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="font-semibold w-40 md:w-80">{item.title}</h3>
                  </div>
                </div>
                ...
                <Button variant="outline" asChild>
                  <a
                    className="order-3 ml-auto flex w-fit items-center gap-2 md:order-none"
                    href={item.link}
                  >
                    <span>Website</span>
